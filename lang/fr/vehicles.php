...
return [
    ...
    'messages' => [
        ...
        'no_vehicles_with_location' => 'Aucun véhicule avec données de localisation',
        'no_vehicle_locations_available' => "Il n'y a pas de véhicules avec des données de localisation disponibles pour le moment.",
        'active' => 'Actif',
    ],
    'fleet_map' => [
    ...
    'map' => [
        ...
        'change_style' => 'Changer le style de carte',
        'style_light' => 'Clair',
        'style_dark' => 'Sombre',
        'style_streets' => 'Rues',
        ...
        'km_per_hour' => 'km/h',
        'vehicles' => 'véhicules',
        'activity_legend' => 'Légende des activités',
