...
return [
    ...
    'messages' => [
        'updated' => 'Boitier mis à jour avec succès.',
        'title' => 'Messages',
        'description' => 'Consulter et gérer les messages et données de localisation',
        'select_date' => 'Sélectionner une date',
        'no_messages_title' => 'Aucun message trouvé',
        'no_messages' => 'Ce périphérique n\'a pas encore envoyé de messages.',
        'no_messages_for_date' => 'Aucun message trouvé pour :date.',
        'message_count' => 'messages',
        'message_total' => ':total messages au total',
        ...
        'speed' => 'Vitesse',
        'heading' => 'Cap',
        'speed_heading' => 'Vitesse & Cap',
        'status' => 'Statut',
        'moving' => 'Statut de Mouvement',
        'moving_state' => 'En mouvement',
        'ignition' => 'Statut du Contact',
        'ignition_on' => 'ON',
        'ignition_off' => 'OFF',
        ...
        'no_data' => 'Aucune donnée de message disponible',
