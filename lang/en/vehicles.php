...
return [
    ...
    'show' => [
        ...
        'sections' => [
            ...
            'tracking' => [
                ...
                'description' => 'Real-time location and route history',
            ],
        ],
    ],
    'confirmations' => [
    ...
    'messages' => [
        ...
        'no_vehicle_locations_available' => 'No vehicles have location data available at this time',
        'no_route_data' => 'No route data available',
        'no_locations_for_date' => 'No location data available for the selected date',
        'no_current_location' => 'No current location data available for this vehicle',
    ...
    'map' => [
        ...
        'show_all_points' => 'All Points',
        'hide_points' => 'Hide Points',
        'enable_camera_follow' => 'Follow Camera',
        'disable_camera_follow' => 'Fixed Camera',
        'jump_to_start' => 'Go to Start',
        'jump_to_end' => 'Go to End',
        'play' => 'Play',
        'pause' => 'Pause',
        'speed' => 'Speed',
        'last_updated' => 'Last Updated',
    ...
    'fleet_stats' => [
        ...
        'idling' => 'Idling',
        'parked' => 'Parked',
        'active_percentage' => 'Active Vehicles',
    ],
]; 