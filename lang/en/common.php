...
return [
    ...
    'update_language_settings' => 'Update your account\'s language preferences',
    ...
    'csv_import' => [
        ...
        'ready_to_import' => ':count records ready to import',
        ...
        'unmapped' => 'unmapped',
        'issues' => 'Issues',
        'rows_with_issues' => ':count rows with issues',
        'row_with_issues' => 'row with issues',
        'row_ignored_count' => ':count ignored',
        'data' => 'Data',
        'rows' => 'rows',
        'valid' => 'valid',
        ...
        'ignored' => 'Ignored',
        'validation_request_failed' => 'Validation request failed',
        'validation_issues' => 'Validation issues',
        'importing' => 'Importing...',
        'import_button' => 'Import :count records',
        'no_issues_found' => 'No issues found',
        'no_data_to_validate' => 'No data to validate',
        'field_specific_errors' => 'Field-specific errors',
        'all_rows_invalid_or_ignored' => 'All rows are invalid or ignored',
        'no_valid_data_for_table' => 'No valid data for preview',
        'pick_a_date' => 'Pick a date',
        'select_placeholder_boolean_none' => 'None',
        'true' => 'Yes',
        'false' => 'No'
    ],
