...
import { useTranslation } from '@/utils/translation'; // Correct the import path

export default function Welcome() {
    const { __ } = useTranslation(); // Initialize the hook
    const { auth } = usePage<SharedData>().props;

    return (
        <>
            <Head title={__('welcome.title')}> {/* Translate title */}
                ...
                <header className="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            ...
                            >
                                {__('common.dashboard')} {/* Translate Dashboard */}
                            </Link>
                        ) : (
                            <>
                                <Link
                                ...
                                >
                                    {__('common.login')} {/* Use common.login */}
                                </Link>
                                <Link
                                    href={route('register')}
                                    className="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]"
                                >
                                    {__('common.register')} {/* Use common.register */}
                                </Link>
                            </>
                        )}
                    </nav>
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-1 font-medium">{__('welcome.get_started_title')}</h1> {/* Translate heading */}
                            <p className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                                {__('welcome.ecosystem_intro_1')} {/* Translate first line */}
                                <br />
                                {__('welcome.ecosystem_intro_2')} {/* Translate second line */}
                            </p>
                            <ul className="mb-4 flex flex-col lg:mb-6">
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                                    ...
                                    <span>
                                        {__('welcome.read_the')}{' '} {/* Translate */}
                                        <a
                                            href="https://laravel.com/docs"
                                            target="_blank"
                                            className="ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                        >
                                            <span>{__('common.documentation')}</span> {/* Use common.documentation */}
                                            <svg
                                                width={10}
                                                height={11}
                                                viewBox="0 0 10 11"
                                ...
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                                    ...
                                    <span>
                                        {__('welcome.watch_tutorials_at')}{' '} {/* Translate */}
                                        <a
                                            href="https://laracasts.com"
                                            target="_blank"
                                            className="ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                        >
                                            <span>{__('welcome.laracasts')}</span> {/* Translate */}
                                            <svg
                                                width={10}
                                                height={11}
                                                viewBox="0 0 10 11"
                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    ...
                                    >
                                        {__('welcome.deploy_now')} {/* Translate */}
                                    </a>
                                </li>
                            </ul>
                        </div>
